...
//             return; // Skip if not a trasform (longest one?)
//         }
        
//         this.classList.remove("pressed"); // 'this' is the keyCode
//     }
...
function handleKeyEventDown(e){
    ...
    // if keydown, add .pressed class
    if (e.type === 'keydown') {
        key.classList.add("pressed");
    }
}

// If keyup - remove .pressed class
...
window.addEventListener("keydown", handleKeyEventDown);
window.addEventListener("keyup", handleKeyEventUp);
